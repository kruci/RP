 ...
 * @author rasto
 */
public class LSMCamera implements Camera{
protected double[][] camToWorld, worldToCam, camToWorld_direction;
            ...
            double AngleX, double AngleY,Color color)
    {
        ...
        {
            tmp = new Math3dUtil.Vector3(0,0,1).normalize();
        }
        ...
        Math3dUtil.Vector3 right = ((tmp).cross(forward)).normalize();
        Math3dUtil.Vector3 up = (forward.cross(right)).normalize();
    ...
    public Math3dUtil.Vector3 GetPosition(){
        return new Math3dUtil.Vector3(camToWorld[3]);
    }
